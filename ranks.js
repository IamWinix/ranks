$(document).ready(function() {
  $(".rank").click(function() {
    ...
    if (rankName === "VIP Rank") {
      payPalInfo = "Pay $2.00 on Paypal: @Lesionv2"";
      ...
      payPalInfo = "Pay $3.50 on on Paypal: @Lesionv2"";
      ...
      payPalInfo = "Pay $5.00 on Paypal: @Lesionv2"";
      ...
      payPalInfo = "Pay $7.00 on on Paypal: @Lesionv2"";
      ...
      payPalInfo = "Pay $10.00 on Paypal: @Lesionv2";
